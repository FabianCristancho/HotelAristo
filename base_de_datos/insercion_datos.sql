...
(2, 'PAÑUELITOS', 0),
(2, 'GEL EGO', 0),
(2, 'CEPILLO DE DIENTES', 0),
(2, 'MÁQUINA DE AFEITAR', 0),
(2, 'CREMA DENTAL', 0),
(2, 'CERA EGO', 0),
(2, 'CREMA DE PEINAR', 0),
(2, 'ALKASELTZER', 0),
...
(3, 'AGUA GRANDE', 0),
(3, 'GASEOSA MANZANA', 0),
(3, 'GASEOSA COLOMBIANA', 0),
(3, 'CANADA DRY', 0),
(3, 'MR TEA DE LIMÓN', 0),
(3, 'MR TEA DE DURAZNO', 0),
(3, 'GATORADE', 0),
(3, 'JUGOS BOTELLA', 0),
(3, 'COCA COLA', 0),
(4, 'TODORICOS', 0),
...
(4, 'CHICHARRÓN', 0),
(4, 'TAJAMIEL', 0),
(4, 'PAPAS SUPER RICAS', 0),
(4, 'DETODITO', 0),
(4, 'CHOCORRAMO', 0),
(4, 'PONQUÉ GALA', 0),
(4, 'MANÍ ESPECIAL', 0),
(4, 'MANÍ DE ARÁNDANOS', 0),
(4, 'SALCHICHAS', 0),
(5, 'MORENITAS', 0),
(5, 'COCOSETTE', 0),
(5, 'TOSH', 0),
...
-- ==========================================TARIFAS (EJEMPLO)===================================================================================================
INSERT INTO tarifas (id_tipo_habitacion, cantidad_huespedes, derecho_desayuno, valor_ocupacion) VALUES 
(1, 2, 1, 75000),
(1, 3, 1, 85000),
(1, 2, 1, 90000),
(2, 1, 0, 80000),
