									...
									<div class="row">
										<div class="form-group in-row col-6 padd">
											...
											<div class="input-group">
												...
												<input class="form-control" type="text" placeholder="Nombres" onkeyup="this.value=this.value.toUpperCase();" onkeydown="checkInputOnlyLetters(event,this);" value="<?php echo "Nom es".$user2->getName();?>" maxlength="60" minlength="2" required>
											</div>
